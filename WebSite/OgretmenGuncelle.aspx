<%@ Page Title="" Language="C#" MasterPageFile="~/Yetkili.Master" AutoEventWireup="true" CodeBehind="OgretmenGuncelle.aspx.cs" Inherits="WebSite.OgretmenGuncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
      <form id="Form1" runat="server">
        <div class="form-group">
            ...
            <asp:TextBox ID="txtOgrtID" runat="server" CssClass="form-control"></asp:TextBox>
            <br />
            <div>
            </div>
            <div>
